...
/// @fn int bajaNacionalidad(eNacionalidad[], int, char[])
/// @brief su funcion es dar de baja una nacionalidad
///
/// @param eNacionalidad unaNacionalidad[]
/// @param int tamNac
/// @param char cadena[]
/// @return retorna 1 si salio bien o 0 si salio mal
int bajaNacionalidad(eNacionalidad unaNacionalidad[], int tamNac, char cadena[]);
